...
if __name__ == '__main__':
    ...
    image = '../data/cvpr-2018-autonomous-driving/test_color'
    image_label = '../data/cvpr-2018-autonomous-driving/test_label'
    saved_location = image.replace('test_color', 'cropped_test_color/')
    saved_location_label = image.replace('test_color', 'cropped_test_label/')
    
    print ("Creating folders")
    sp.call(['mkdir', osp.join(root, 'cropped_test_color')])
    sp.call(['mkdir', osp.join(root, 'cropped_test_label')])
    
    directory = os.fsencode('../data/cvpr-2018-autonomous-driving/test_color')
    new_directory = os.fsencode('../data/cvpr-2018-autonomous-driving/cropped_test_color')
    index = 0
